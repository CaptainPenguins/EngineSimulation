...
%   Problem parameters
T_c = 2700.8;     % Temperature in the combustion chamber (K)
P_c = 2.4e6;    % Pressure in the combustion chamber (Pa)
P_amb = 101e3;  % Ambient pressure (Pa)
T_amb = 300;    % Ambient temperature (K)
gamma = 1.1609;   % Ratio of Specific Heats Cp/Cv (Gamma)
W = 39.6;       % Molecular weight of gas (kg/kmol)
width = .0381;     % Nozzle width (meters)
h_th = .01397*2;    % Throat  height (meters)
